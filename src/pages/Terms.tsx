        ...
        >
          ...
          <div className="space-y-8 text-on-surface/80">
            <section>
              ...
              <p className="mb-4">
                By accessing or using KB Growth's website and services, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                KB Growth provides growth marketing, SEO, and consulting services. The specific deliverables and scope of work will be outlined in a separate Statement of Work (SOW) or contract agreed upon by both parties.
              </p>
            </section>
            ...
            <section>
             ...
             <section>
              ...
              <p className="mb-4">
                KB Growth shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or related to your use of our services.
              </p>
            </section>
